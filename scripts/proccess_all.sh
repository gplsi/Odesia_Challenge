...
for lang in "${languages[@]}"; do
  for i in "${!task_keys[@]}"; do
    ...
    python -m src.scripts.langchain_pipeline --language $lang --partition $partition  --task_key $task_key --shot_value $shot_value --version $version
  done
done
