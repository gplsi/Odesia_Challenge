...
def get_task_foo_examples():
    ...
    examples = [
        ...
        Example(
            text="TASK FOO OMG a t-rex!", task_id=task_id, content={"key": "value"}
        ),
        Example(
            text="ANIMALS AND DINOSAURS WOW", task_id=task_id, content={"key": "value"}
        ),
        Example(
...
def get_task_foo_2_examples():
    ...
    examples = [
        Example(
            text="my car is big", task_id=task_id, content={"any_json": "structure"}
        ),
        Example(
...
def main():
    ...
    with get_weaviate_client() as client:
        ...
        results, stats = rag_service.retrieve_examples(
            query_text="a fish once saw a scorpio and ran away", k=2
        )
